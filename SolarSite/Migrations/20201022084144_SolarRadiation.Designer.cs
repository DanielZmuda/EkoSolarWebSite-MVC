...
namespace SolarSite.Migrations
{
    ...
    [Migration("20201022084144_SolarRadiation")]
    partial class SolarRadiation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SolarSite.Data.Entities.StoreUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SolarSite.Entities.Order", b =>
                {
                    b.HasOne("SolarSite.Data.Entities.StoreUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
